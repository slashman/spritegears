 ...
 * with the object you want to check, and then call {@link #writeObject(Object)}. When a
 * non-serializable object is found, a {@link NotSerializableException} is
 ...
 *
 * <p>
 * Modified by Adam Crume to remove all Wicket-specific logic and add various minor improvements.
 * </p>
 *
...
public class SerializableChecker extends ObjectOutputStream {
        ...
        static {
                try {
                        ...
                        getObjFieldValues = ObjectStreamClass.class.getDeclaredMethod("getObjFieldValues", new Class[] {Object.class, Object[].class});
